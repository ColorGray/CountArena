...
"use strict";{const e="mouse",t=class extends self.DOMHandler{#e=!1;#t=!1;#o="";constructor(t){super(t,e),this.AddRuntimeMessageHandlers([["init",e=>this.#r(e)],["cursor",e=>this.#n(e)],["request-pointer-lock",e=>this.#i(e)],["release-pointer-lock",()=>this.#s()]]),document.addEventListener("pointerlockchange",e=>this.#l()),document.addEventListener("pointerlockerror",e=>this.#a())}#r(e){this.#e=e["isPointerLockWrapperPolyfill"],this.#e&&(this._iRuntime._AddWrapperMessageHandler("set-pointer-lock-enabled-response",e=>this.#c(e)),this._iRuntime._AddWrapperMessageHandler("pointer-lock-movement",e=>this.#p(e)),window.addEventListener("blur",()=>this.#h()))}#n(e){this.#o=e,"linux-cef"===this._iRuntime.GetExportType()&&this.#t||(document.documentElement.style.cursor=e)}#i(e){this.#e?("linux-cef"===this._iRuntime.GetExportType()&&(this.#t=!0,document.documentElement.style.cursor="none"),this._iRuntime._SendWrapperMessage({"type":"set-pointer-lock-enabled","isEnabled":!0})):this._iRuntime.GetMainCanvas().requestPointerLock(e)}#s(){this.#e?this._iRuntime._SendWrapperMessage({"type":"set-pointer-lock-enabled","isEnabled":!1}):document.exitPointerLock()}#l(){this.PostToRuntime("pointer-lock-change",{"hasPointerLock":!!document.pointerLockElement})}#a(){this.PostToRuntime("pointer-lock-error",{"hasPointerLock":!!document.pointerLockElement})}#c(e){e["isOk"]?(this.#t=e["isEnabled"],this.PostToRuntime("pointer-lock-change",{"hasPointerLock":e["isEnabled"]})):(console.error(`[Mouse] Unable to obtain pointer lock (via wrapper): error ${e["error"]}`),this.#t=!1,this.PostToRuntime("pointer-lock-error",{"hasPointerLock":!1})),"linux-cef"!==this._iRuntime.GetExportType()||this.#t||(document.documentElement.style.cursor=this.#o)}#p(e){this.PostToRuntime("wrapper-pointer-lock-movement",{"movementX":e["movementX"],"movementY":e["movementY"]})}#h(){this.#s()}};self.RuntimeInterface.AddDOMHandlerClass(t)}
...
// start-export.js
"use strict";if(window["C3_IsSupported"]){const e=true;window["c3_runtimeInterface"]=new self.RuntimeInterface({useWorker:e,workerMainUrl:"workermain.js",runtimeMainScript:"scripts/c3main.js",scriptFolder:"scripts/",exportType:"html5"})}
